...
/*
    ...
    -----------------------------------------
    not matched                             0
    matched                           155,680  (merge_housing_expenditure==3)
    -----------------------------------------
*/
...
/*
    ...
    -----------------------------------------
    not matched                        33,851
        from master                    33,851  (merge_educ==1)
        from using                          0  (merge_educ==2)

    matched                           121,829  (merge_educ==3)
    -----------------------------------------
*/
...
/*
  Result                           # of obs.
    -----------------------------------------
    not matched                        71,892
        from master                    71,892  (merge_employment==1)
        from using                          0  (merge_employment==2)

    matched                            83,788  (merge_employment==3)
    -----------------------------------------
...
/*
    ...
    -----------------------------------------
    not matched                             0
    matched                           155,680  (merge_funcdiff==3)
    -----------------------------------------
*/
...
/*
  ...
  Result                           # of obs.
    -----------------------------------------
    not matched                       131,637
        from master                   131,637  (merge_fp==1)
        from using                          0  (merge_fp==2)

    matched                            24,043  (merge_fp==3)
    -----------------------------------------
