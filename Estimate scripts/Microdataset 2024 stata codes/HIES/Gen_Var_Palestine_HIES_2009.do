...
replace admin1=. if admin1==41 //admin1 41 has no label
...
local diffvars seeing_diff_new hearing_diff_new mobility_diff_new cognitive_diff_new comm_diff_new
...
save "D:\DDI\New Indicator\Palestine_HIES_2009_Clean.dta",replace
