...
use "D:\DDI\Estimate run\Census\Kenya Revised 2019Census_TenPercent\2019TenPercent_Deaths.dta",clear
egen child_died=max(H16 <18),by(COUNTY subcounty_code divisionname_code locationname_code sublocation_code EA ENUMERATOR_ID STRNUMBER HHNUMBER )
duplicates drop COUNTY subcounty_code divisionname_code locationname_code sublocation_code EA ENUMERATOR_ID STRNUMBER HHNUMBER, force
keep child_died COUNTY subcounty_code divisionname_code locationname_code sublocation_code EA ENUMERATOR_ID STRNUMBER HHNUMBER
merge 1:1 COUNTY subcounty_code divisionname_code locationname_code sublocation_code EA ENUMERATOR_ID STRNUMBER HHNUMBER using "D:\DDI\Estimate run\Census\Kenya Revised 2019Census_TenPercent\2019TenPercent_Households.dta",gen(_merge_child_death)
merge 1:m COUNTY subcounty_code divisionname_code locationname_code sublocation_code EA ENUMERATOR_ID STRNUMBER HHNUMBER using "D:\DDI\Estimate run\Census\Kenya Revised 2019Census_TenPercent\2019TenPercent_Population.dta",gen(_merge_ind)*/

use "D:\DDI\Estimate run\Census\Kenya Revised 2019Census_TenPercent\2019TenPercent_Population.dta", clear
merge m:1 COUNTY subcounty_code divisionname_code locationname_code sublocation_code EA ENUMERATOR_ID STRNUMBER HHNUMBER using "D:\DDI\Estimate run\Census\Kenya Revised 2019Census_TenPercent\2019TenPercent_Households.dta"

save "D:\DDI\Estimate run\Census\2019TenPercent_Merged.dta",replace
...
clonevar cognitive_diff_new=P42_4
replace cognitive_diff_new=. if P42_4>4
...
/* keep command
keep country_name country_abrev country_dataset_year ind_id hh_id admin1 admin2 female age age_group urban_new seeing_diff_new hearing_diff_new mobility_diff_new cognitive_diff_new selfcare_diff_new comm_diff_new func_difficulty disability_* *_any *_some *_atleast_alot everattended_new edattain_new ind_atleastprimary_all ind_atleastprimary ind_atleastsecondary ind_emp youth_idle work_manufacturing work_informal computer internet mobile_own ind_water ind_toilet ind_electric ind_cleanfuel ind_livingcond ind_asset_ownership cell_new ind_floor ind_roof ind_wall ind_radio ind_tv ind_refrig ind_bike ind_motorcycle ind_autos ind_computer deprive_educ deprive_work deprive_health_water deprive_health_sanitation deprive_sl_electricity deprive_sl_fuel deprive_sl_housing deprive_sl_asset mdp_score  ind_mdp
*/
...
save "D:\DDI\Estimate run\Census\Kenya_Census_2019_Cleaned_Individual_Data_Trimmed.dta", replace
