...
cd "D:\DDI\New Datasets\TGO_2021_EHCVM-2_v01_M_STATA14"

*****************New Datasets************************************************
*****************Household data Clean & merge***********************************
use "ehcvm_conso_tgo2021.dta",clear
...
/*    Result                      Number of obs
    -----------------------------------------
    Not matched                           488
        from master                       488  (_merge_asset==1)
        from using                          0  (_merge_asset==2)

    Matched                             5,974  (_merge_asset==3)
    -----------------------------------------
*/


merge 1:1 grappe menage vague using "s08a_me_tgo2021.dta", generate(_merge_food)


/*    Result                      Number of obs
    -----------------------------------------
    Not matched                             0
    Matched                             6,462  (_merge_food==3)
    -----------------------------------------
*/
...
/*    Result                      Number of obs
    -----------------------------------------
    Not matched                             0
    Matched                             6,462  (_merge_health_exp==3)
    -----------------------------------------
*/
...
/*	Result                      Number of obs
    -----------------------------------------
    Not matched                             0
    Matched                             6,462  (_merge_social_prot==3)
    -----------------------------------------
*/

drop _merge_asset _merge_food _merge_shock _merge_health_exp _merge_social_prot
save "TGO_LSMS_2021_HH.dta", replace
*************************************************************************************************************************************************
use "ehcvm_individu_tgo2021.dta",clear
rename numind membres__id
merge 1:1 grappe menage vague membres__id using "s04a_me_tgo2021.dta",gen(_merge_s04a)

/*    Result                      Number of obs
    -----------------------------------------
    Not matched                             0
    Matched                            28,815  (_merge_s04a==3)
    -----------------------------------------
*/
...
count
merge 1:1 grappe menage vague membres__id using "s04b_me_tgo2021.dta",gen(_merge_s04b)

/*      Result                      Number of obs
    -----------------------------------------
    Not matched                             0
    Matched                            28,815  (_merge_s04b==3)
    -----------------------------------------
...
count
merge 1:1 grappe menage vague membres__id using "s03_me_tgo2021.dta", gen(_merge_s03)

/*      Result                      Number of obs
    -----------------------------------------
    Not matched                             0
    Matched                            28,815  (_merge_s03==3)
    -----------------------------------------
...
save "TGO_LSMS_2021_Ind.dta", replace 

use "TGO_LSMS_2021_HH.dta",clear
merge 1:m grappe menage vague using "TGO_LSMS_2021_Ind.dta"

/*    Result                      Number of obs
    -----------------------------------------
    Not matched                             0
    Matched                            28,815  (_merge==3)
    -----------------------------------------*/
*keep if vague==1
bysort hhid: gen hh_size = _N
save "Togo 2021 raw.dta", replace 
use "Togo 2021 raw.dta",clear

drop if age<15
********Country Name****************
gen country_name="Togo"
********Country Abrevation*********
gen country_abrev="TG" 

*********Country_dataset_year*******
gen country_dataset_year="Togo LSMS 2021-2022"
...
save "Togo_LSMS_2021.dta",replace 
...
save "Togo_LSMS_2021 with missing.dta", replace
...
save "Togo_LSMS_2021_Cleaned_Individual_Data_Trimmed.dta", replace

duplicates drop hh_id, force

save "Togo_LSMS_2021_Cleaned_Household_Level_Data_Trimmed.dta", replace
